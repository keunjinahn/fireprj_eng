    ...
    <div class="login-panel">
      <div class="login-panel-inner">
        <div class="login-legend">
          <h1>A.N.Fire Solutions<br>Integrated Fire Monitoring System</h1>
        </div>
            ...
            <div class="login-inner">
              <v-form>
                ...
                <div class="mb-4 btn-center">
                  <v-btn width="250" height="50" color="primary" @click="login" :loading="loading">Log in</v-btn>
                </div>                
              </v-form>
            </div>
  ...
  methods: {
    async login() {
      if (!this.form.username || !this.form.password)
        return (this.error = 'Please enter your ID and password.')
