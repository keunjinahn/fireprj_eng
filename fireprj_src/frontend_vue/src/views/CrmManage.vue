                    ...
                    <abl-doc-body class="abl-doc-body-popup">
                      <table class="abl-table-ts-popup">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                               <input :disabled="addPopup.popup_type == 'VIEW'" type="text" placeholder="Customer name" class="abl-input" v-model="addPopup.form.customer_name"/>
                            </td>
                        </tr>          
                        <tr>
                          <th class="s-h" colspan="2" rowspan="1">Tel</th>
                          <td colspan="2">
                            <input :disabled="addPopup.popup_type == 'VIEW'" type="text" placeholder="Tel" class="abl-input" v-model="addPopup.form.customer_tel"/>
                          </td>
                        </tr>   
                        <tr>
                          <th class="s-h" colspan="2" rowspan="1">Address</th>
                          <td colspan="2">
                            <input :disabled="addPopup.popup_type == 'VIEW'" type="text" placeholder="Address" class="abl-input" v-model="addPopup.form.customer_address"/>
                          </td>
                        </tr>   
                      </table>
                    </abl-doc-body>
...
export default {
  ...
  methods: {
    ...
    getPopupTitle(type){
      if(type == 'ADD') return 'Customer register'
      if(type == 'MODIFY') return 'Customer modify'
      if(type == 'VIEW') return 'Customer infomation'
    },
    async getUser() {
    ...
    async downloadExcel() {
      ...
      .then(response => {
        ...
        link.href = url
        var download_file_name = "Customer_list_" + Date.now().toString() + ".xlsx"
    ...
    return {
      users: {
        headers: [
          ...
          {text: 'Customer name', value: 'customer_name', sortable: false,align: 'center', width: 80},
          {text: "Tel", value: "customer_tel",align: 'center', sortable: false, width: 60},
          {text: "Address", value: "customer_address",align: 'center', sortable: false, width: 40},
