          ...
          <v-row>
            <v-col cols="6">
              <v-card light outlined color="white">
                <v-card-title class="body-1 font-weight-bold py-2">Sensor Operation status</v-card-title>
                <v-divider/>
                <v-card-text>
                  <highcharts
...
export default {
  ...
  computed: {
    chart1Option () {
      ...
      obj.series[0].name = 'Number of operating sensors'
      obj.series[1].data = this.data.by_year.map(v => (Math.floor(v.cost/1000000)))
      obj.series[1].name = 'Number of sensors not in operation'
  ...
  data() {
    return {
      sensor: {
        headers: [
          {text: "Event", value: "event_idx", sortable: false,align: 'center', width: 80},
          {text: "System No.", value: "system_id_c",align: 'center', sortable: false, width: 60},
          {text: "Repeater No.", value: "repeater_id_c",align: 'center', sortable: false, width: 40},
          {text: "Sensor No.", value: "sensor_id_c",align: 'center', sortable: false, width: 20},
          {text: "Sensor current value", value: "sensor_value_c",align: 'center', sortable: false, width: 20},
          {text: "I/O terminal number", value: "inout_id_c",align: 'center', sortable: false, width: 20},
          {text: "Event desc", value: "event_desc",align: 'center', sortable: false, width: 20},
        ],
        data: [],
