    ...
    <template v-slot>
      <div class="main-panel">
        <v-toolbar color="light-blue darken-4" dark flat>
          <v-toolbar-title>Latest event status</v-toolbar-title>
        </v-toolbar>
    ...
    return {
      sensor: {
        ...
        headers: [
          ...
          {text: "Customer name", value: "customer.customer_name",align: 'center', sortable: false, width: 40},
          {text: "Receiver type", value: "receiver_type",align: 'center', sortable: false, width: 80},
          ...
          {text: "Register status", value: "register_status",align: 'center', sortable: false, width: 20},
          {text: "Operation status", value: "action_status",align: 'center', sortable: false, width: 20},
          {text: "Comm. status", value: "com_status",align: 'center', sortable: false, width: 20},
          {text: "Battery status", value: "battery_status",align: 'center', sortable: false, width: 20},
        ],
        data: [],
      ...
      event: {
        headers: [
          {text: 'No.', value: 'id', sortable: false, align: 'center', width: 20 },
          {text: "Event time", value: "event_datetime", sortable: false,align: 'center', width: 80}, 
          {text: "Event category", value: "event_category", sortable: false,align: 'center', width: 80},
          {text: "Event desc", value: "event_desc", sortable: false,align: 'center', width: 100},
          {text: "Customer name", value: "customer_name",align: 'center', sortable: false, width: 40},
          {text: "Receiver type", value: "receiver_type",align: 'center', sortable: false, width: 80},
          {text: "Receiver No.", value: "receiver_id",align: 'center', sortable: false, width: 20},
          {text: "System No.", value: "system_id",align: 'center', sortable: false, width: 20},
          {text: "Repeater No.", value: "repeater_id",align: 'center', sortable: false, width: 20},
