    ...
    <template v-slot>
      <div class="main-panel">
        <v-toolbar color="light-blue darken-4" dark flat>
          <v-toolbar-title>Receiver management</v-toolbar-title>
        </v-toolbar>
                  ...
                  <abl-document class="abl-page-popup" ref="report-popup">
                    <abl-doc-body class="abl-doc-body-popup">
                      <table class="abl-table-ts-popup">
                        ...
                        <tr>
                            <th class="s-h" colspan="2" rowspan="1">Customer name</th>
                            <td colspan="2">
                        ...
                        <tr>
                          <th class="s-h" colspan="2" rowspan="1">Customer address</th>
                          <td colspan="2">
                            <input type="text" disabled placeholder="Customer address" class="abl-input" v-model="addPopup.form.customer_address"/>
                          </td>
                        </tr>   
                        <tr>
                          <th class="s-h" colspan="2" rowspan="1">Customer tel</th>
                          <td colspan="2">
                            <input type="text" disabled placeholder="Customer tel" class="abl-input" v-model="addPopup.form.customer_tel"/>
                          </td>
                        </tr>   
                        <tr>
                          <th class="s-h" colspan="2" rowspan="1">Customer ID</th>
                          <td colspan="2">
                            <input type="text" disabled placeholder="Customer ID" class="abl-input" v-model="addPopup.form.customer_idx"/>
                          </td>
                        </tr>     
                        <tr>
                          <th class="s-h" colspan="2" rowspan="1">Receiver type</th>
                          <td colspan="2">
                            <input type="text" :disabled="addPopup.popup_type == 'VIEW'" placeholder="000" class="abl-input" v-model="addPopup.form.receiver_type"/>
                          </td>
                        </tr>       
                        <tr>
                          <th class="s-h" colspan="2" rowspan="1">Receiver No</th>
                          <td colspan="2">
...
export default {
  ...
  methods: {
    ...
    getPopupTitle(type){
      if(type == 'ADD') return 'Receiver register'
      if(type == 'MODIFY') return 'Receiver modify'
      if(type == 'VIEW') return 'Receiver infomation'
    },  
    clearPopup(){
      this.addPopup.form = {
          receiver_idx: '',
    ...
    async downloadExcel() {
      ...
      .then(response => {
        ...
        link.href = url
        var download_file_name = "ReceiverList_" + Date.now().toString() + ".xlsx"
    ...
    return {
      ...
      receiver: {
        headers: [
          ...
          {text: 'Receiver ID', value: 'receiver_idx', sortable: false,align: 'center', width: 80},
          {text: "Customer ID", value: "fk_customer_idx",align: 'center', sortable: false, width: 60},
          {text: "Receiver type", value: "receiver_type",align: 'center', sortable: false, width: 40},
          {text: "Receiver No", value: "receiver_id",align: 'center', sortable: false, width: 20},
