    ...
    <template v-slot>
      <div class="main-panel">
        <v-toolbar color="light-blue darken-4" dark flat>
          <v-toolbar-title>Sensor management</v-toolbar-title>
        </v-toolbar>
                  ...
                  <abl-document class="abl-page-popup" ref="report-popup">
                    <abl-doc-body class="abl-doc-body-popup">
                      <table class="abl-table-ts-popup">
                        ...
                        <tr>
                          <th class="s-h" colspan="2" rowspan="1">Customer management ID</th>
                          <td colspan="2">
                            <input type="text" disabled placeholder="Customer management ID" class="abl-input" v-model="addPopup.form.customer_idx"/>
                          </td>
                        </tr>     
                        <tr>
                        ...
                        <tr>
                          <th class="s-h" colspan="2" rowspan="1">Sensor No.</th>
                          <td colspan="2">
...
export default {
  ...
  methods: {
    ...
    getPopupTitle(type){
      if(type == 'ADD') return 'Sensor registration'
      if(type == 'MODIFY') return 'Sensor modify'
      if(type == 'VIEW') return 'Sensor infomation'
    },
    clearPopup(){
      this.addPopup.form = {
          sensor_idx: '',
