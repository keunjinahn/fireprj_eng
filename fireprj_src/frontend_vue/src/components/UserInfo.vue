  ...
  <div style="width: 1000px">
    ...
    <v-dialog v-model="popup.del_user.show" max-width="500px">
      <v-card>
        ...
        <v-card-actions>
          <v-btn tile depressed class="flex-grow-1" @click="deleteUser()">Delete</v-btn>
          <v-btn tile depressed class="flex-grow-1" @click="popup.del_user.show = false">Cancle</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
